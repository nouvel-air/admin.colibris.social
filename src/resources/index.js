...
export { default as Colibris } from './Colibris';
...
// Le Mag
export { default as Document } from './LeMag/Document';
export { default as LeMag } from './LeMag';

// L'Université
export { default as Course } from './LUniversite/Course';
export { default as LUniversite } from './LUniversite';

// Près de chez nous
export { default as Organization } from './Pdcn/Organization';
export { default as Pdcn } from './Pdcn';
